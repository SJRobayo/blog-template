    ...
    <section class="py-6 relative">
        <div class="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
            <div class="w-full flex-col justify-start items-start lg:gap-10 gap-6 inline-flex">
                <h2 class="text-gray-900 text-3xl font-bold font-manrope leading-normal">{{$post->comments->count()}} Comments</h2>
                <div class="w-full flex-col justify-start items-start lg:gap-9 gap-6 flex">
                    <div class="w-full relative flex justify-between gap-2">
                        <textarea wire:model="comment"
                            ...
                            placeholder="Write comments here...." rows="1" oninput="this.style.height = ''; this.style.height = this.scrollHeight + 'px'"></textarea>
                        <a wire:click="postComment()" class="absolute right-6 bottom-3">
                            ...
                            <div class="w-full justify-between items-center inline-flex">
                                <div class="justify-start items-center gap-2.5 flex">
                                    ...
                                    <div class="flex-col justify-start items-start gap-1 inline-flex">
                                        ...
                                        <h6 class="text-gray-500 text-xs font-normal leading-5">{{$comment->created_at}}</h6>
                                    </div>
                                </div>
                            ...
                            <div class="justify-end items-center gap-1 flex">
                                ...
                                <div class="justify-start items-start flex -space-x-2 overflow-hidden">
                                    <div
                                        ...
                                        <img class="w-3 h-3" src="https://pagedone.io/asset/uploads/1716545141.png"
                                            alt="Thumbs Up emoji" />
                                    </div>
                                    <div
                                        class="p-1.5 inline-block ring-1 ring-white bg-gray-100 rounded-full border border-white justify-center items-center flex">
                                        <img class="w-3 h-3" src="https://pagedone.io/asset/uploads/1716545183.png"
                                            alt="Smiling eyes emoji" />
                                    </div>
                                    <div
                                        class="p-1.5 inline-block ring-1 ring-white bg-gray-100 rounded-full border border-white justify-center items-center flex">
                                        <img class="w-3 h-3" src="https://pagedone.io/asset/uploads/1716545217.png"
